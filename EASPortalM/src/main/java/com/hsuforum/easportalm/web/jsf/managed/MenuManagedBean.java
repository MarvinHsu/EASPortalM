package com.hsuforum.easportalm.web.jsf.managed;
...
import com.hsuforum.easportalm.ws.vo.GroupWSVO;
	...
	public void init() {
       ...
       // Map attributes = principal.getAttributes();
        ...
        if(principal instanceof UserWSVO) {
	        ...
	        log.info("login easportalm userWSVO ="+userWSVO);
        	...
        	log.info("login easportalm principal ="+principal);
        }
	}
